...
public class addShopCartAnim{
		...
		public addShopCartAnim(Context context,Handler handler,View shopCart){
		...
		public void setShopCartAnim(ViewGroup anim_mask_layout,ImageView buyImg,int[] start_location){
...
//			animLayout.setId(Integer.MAX_VALUE);
		...
		private void setAnim(final View v, int[] start_location) {
			...
			MainActivity.tabs[2].getLocationInWindow(end_location);// shopCart是那个购物车
